...
<nav class="w3-sidenav w3-center w3-small w3-green w3-hide-small">
  ...
  <br><br><br><br>
  <a class="w3-padding-large  w3-hover-white" href="Homepage.php">
    <i class="fa fa-home w3-xxlarge"></i>
    <p>HOME</p>
  </a>
  <a class="w3-padding-large  w3-hover-white" href="Homepage.php#about">
...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <ul class="w3-navbar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    <li class="w3-left" style="width:25% !important"><a href="Homepage.php">HOME</a></li>
    <li class="w3-left" style="width:25% !important"><a href="Homepage.php#about">ABOUT</a></li>
...
<div class="w3-padding-large" id="main">
  ...
  <!-- Portfolio Section -->
   ...
   <div class=" w3-content" id="admin">
   <br>
    <h2 class="w3-text-light-green">Students Arrival</h2>
    <hr style="width:200px" class="w3-opacity">

     <p><label>Scan your Id Card:</label><br><br>
	 <input class="w3-input w3-border w3-padding-16" type="text" placeholder="Student Id" value="<?php if (isset($_POST['sid'])) { echo $_POST['sid']; }  ?>" name="sid" id='sid' style='width:50%'></p>
	 <button class='w3-btn w3-white w3-padding-large' type='submit' name='view'></button>
